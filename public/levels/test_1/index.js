...
const op_2_1     = g_touch(op_1_shapes).stops(op_2_loop);
const op_3_1     = g_touch(op_1_shapes).stops(op_3_loop);
const op_1_2     = g_touch(op_1_shapes, dx_2, dy_2).stops(op_1_loop);
const op_3_2     = g_touch(op_1_shapes, dx_2, dy_2).stops(op_3_loop);
const op_1_3     = g_touch(op_1_shapes, dx_3, dy_3).stops(op_1_loop);
const op_2_3     = g_touch(op_1_shapes, dx_3, dy_3).stops(op_2_loop);
const op_1_x     = g_touch(op_x_shapes).stops(op_1_loop);
const op_2_x     = g_touch(op_x_shapes).stops(op_2_loop);
const op_3_x     = g_touch(op_x_shapes).stops(op_3_loop);
...
const op_2_3_once   = g_once(closing_1_frames, dx_3, dy_3).starts(walk_2_3_once);
...
const op_1_x_once     = g_once(closing_x_frames).starts(walk_1_3_x_once);
const op_2_x_once     = g_once(closing_x_frames).starts(walk_2_3_x_once);
const op_3_x_once     = g_once(closing_x_frames).starts(walk_3_x_once);

const noop_2_1_once = g_once(closing_1_frames,    0,    0).starts(sel_2_1, sel_2_3, sel_2_x);
const noop_3_1_once = g_once(closing_1_frames,    0,    0).starts(sel_3_1, sel_3_2, sel_3_x);
const noop_1_2_once = g_once(closing_1_frames, dx_2, dy_2).starts(sel_1_2, sel_1_3, sel_1_x);
const noop_3_2_once = g_once(closing_1_frames, dx_2, dy_2).starts(sel_3_1, sel_3_2, sel_3_x);
const noop_1_3_once = g_once(closing_1_frames, dx_3, dy_3).starts(sel_1_2, sel_1_3, sel_1_x);
const noop_2_3_once = g_once(closing_1_frames, dx_3, dy_3).starts(sel_2_1, sel_2_3, sel_2_x);
const noop_1_x_once = g_once(closing_x_frames,    0,    0).starts(sel_1_2, sel_1_3, sel_1_x);
const noop_2_x_once = g_once(closing_x_frames,    0,    0).starts(sel_2_1, sel_2_3, sel_2_x);
const noop_3_x_once = g_once(closing_x_frames,    0,    0).starts(sel_3_1, sel_3_2, sel_3_x);
...
switch_2_1.starts(op_2_1_once);
switch_3_1.starts(op_3_1_once);
switch_1_2.starts(op_1_2_once);
switch_3_2.starts(op_3_2_once);
switch_1_3.starts(op_1_3_once);
switch_2_3.starts(op_2_3_once);
switch_1_x.starts(op_1_x_once);
switch_2_x.starts(op_2_x_once);
switch_3_x.starts(op_3_x_once);
